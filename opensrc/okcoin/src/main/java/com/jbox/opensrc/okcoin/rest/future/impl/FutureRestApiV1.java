package com.jbox.opensrc.okcoin.rest.future.impl;
...
import com.jbox.opensrc.okcoin.rest.HttpsUtilManager;
import com.jbox.opensrc.okcoin.rest.MD5Util;
import com.jbox.opensrc.okcoin.rest.StringUtil;
import com.jbox.opensrc.okcoin.rest.future.IFutureRestApi;
...
public class FutureRestApiV1 implements IFutureRestApi {
	...
	public String future_ticker(String symbol, String contractType)
		...
		HttpsUtilManager httpUtil = HttpsUtilManager.getInstance();
		String param = "";
