...
rem xml解析相关包
call mvn install:install-file -Dfile=.\jaxen-1.1.6.jar -DgroupId=com.jbox.outlib -DartifactId=jaxen -Dversion=1.1.6 -Dpackaging=jar
call mvn install:install-file -Dfile=.\dom4j-1.6.1.jar -DgroupId=com.jbox.outlib -DartifactId=dom4j -Dversion=1.6.1 -Dpackaging=jar
